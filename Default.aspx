...
<body>
    <form id="mainForm" runat="server">
        <div id="topPanel">
                ...
                <span id="mainText">DICOM BROWSER</span>
        </div>
        <div id="leftPanel">
            <div id="leftRealMoveButtonsSubpanel" class="leftSubpanel">
                <asp:ImageButton CssClass="leftSmallButton leftButton" ID="upMoveButton" runat="server" ImageUrl="Aiga_uparrow.png" OnClientClick="moveVPUp(); return false;"/><br />
                <asp:ImageButton CssClass="leftSmallButton leftButton" ID="leftMoveButton" runat="server" ImageUrl="Aiga_leftarrow.png" OnClientClick="moveVPLeft(); return false;"/>
                <asp:ImageButton CssClass="leftSmallButton leftButton" ID="rightMoveButton" runat="server" ImageUrl="Aiga_rightarrow.png" OnClientClick="moveVPRight(); return false;" /><br />
                <asp:ImageButton CssClass="leftSmallButton leftButton" ID="downMoveButton" runat="server" ImageUrl="downarrow.png" OnClientClick="moveVPDown(); return false;"/>
            </div>
            <div id="leftMoveButtonsSubpanel" class="leftSubpanel">
                ...
                <div id="ZoomDiv"><img src="zoom.png" class="rangePic" alt="B"/><input type="range" id="zoomrange" class="range" min="0" max="10" value="0"/></div><br />
            </div>
